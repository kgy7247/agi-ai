...
- `M7` 지속적인 유용 자율성: a multi-cycle autonomy run accepts useful verified improvements, rejects failed work, and records rollback plus human override checks.

It is not an AGI candidate yet. The remaining blocker is independent review quorum for the AGI-candidate label.

...
def room_manifest(state: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "entry_contract": {
            ...
            "read_agi_seed": "GET /api/seed",
            "ask_seed_question": "POST /api/seed/question",
            "answer_seed_question": "POST /api/seed/answer",
            ...
            "seed_answer_schema": {
                ...
                "question": "string",
                "answer": "string",
                "evidence": "artifact path, command, URL, or empty",
                "result": "pass | fail | needs-review",
            },
        },
        "operating_rules": [
        ...
        "cross_node_reproduction_runs": state.get("cross_node_reproduction_runs", []),
        "generalization_eval_runs": state.get("generalization_eval_runs", []),
        "long_run_autonomy_runs": state.get("long_run_autonomy_runs", []),
